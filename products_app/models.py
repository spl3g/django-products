...
class Product(UUIDMixin):
    name = models.TextField(max_length=SHORT_TEXT_MAX)
    category_id = models.ManyToManyField(Category, through='ProductCategory')
...
class Supplier(UUIDMixin):
    name = models.TextField(max_length=SHORT_TEXT_MAX)
    phone = models.TextField(max_length=SHORT_TEXT_MAX, validators=[check_phone])
...
class ProductSupplier(models.Model):
    product_id = models.ForeignKey(Product, models.CASCADE)
    supplier_id = models.ForeignKey(Supplier, models.CASCADE)
...
class ProductCategory(models.Model):
    product_id = models.ForeignKey(Product, models.CASCADE, unique=True)
